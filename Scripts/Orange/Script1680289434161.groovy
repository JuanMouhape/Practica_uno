...
WebUI.setText(findTestObject('Object Repository/Orange/Page_OrangeHRM/input_Username_username'), 'Admur')
...
WebUI.click(findTestObject('Object Repository/Orange/Page_OrangeHRM/i_-- Select --_oxd-icon bi-caret-up-fill ox_627fec'))
